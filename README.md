...
| ≈ **Water Hazards (OSM)**    | Quarry pits, irrigation tanks, lakes, ponds, reservoirs and beaches mapped in OpenStreetMap, loaded for the current city-scale view; the places where drownings are most often reported, not a verified register                                                                                                                                                              | OpenStreetMap (Overpass)                | 🟢                                                                                                  |
| ☀️ **Heat Stress**            | Feels-like temperature at Indian state capitals, big cities and Tamil Nadu towns in NOAA heat-index bands, now and forecast maxima, with IMD heat-wave temperature thresholds flagged                                                                                                                                                                                             | Open-Meteo                              | 🟢                                                                                                  |
| ⚠️ **India Alerts (SACHET)** | Live Government of India CAP alerts (IMD, CWC, INCOIS, State DMAs) drawn as severity-tinted warning areas, with All-India / Tamil Nadu and severity filters                                                                                                                                                                                                                       | NDMA SACHET                             | 🟢                                                                                                  |
...
| 🌀 **Cyclones · JTWC**      | Warning positions, forecast tracks and 34-knot danger swaths for the Northwest Pacific, North Indian Ocean (Bay of Bengal, Arabian Sea) and Southern Hemisphere                                                                                                                                                                                                                      | JTWC                                    | 🟢                                                                                                  |
